...
//
function WebFXTabPane( el, classNameTag, bUseCookie) {
	...
	classNameTag = classNameTag != null ? classNameTag : this.classNameTag;
	
	// add class name tag to class name
	this.element.className = classNameTag + " " + this.element.className;
