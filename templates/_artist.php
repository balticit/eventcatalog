		...
		<td style="vertical-align:top">
				...
				<div style="padding-left: 0px;"> 
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<td width="50%"><div class="recomendTitle artist h3">EVENT КАТАЛОГ рекомендует</div>
								...
								<td width="50%"><div class="recomendTitle common h3"><a class="common" href="/added">Новые артисты</a></div>
