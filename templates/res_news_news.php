...
<?php if(!$this->is_list){ ?> 
<td style="padding-left: 30px; padding-right: 30px; padding-top: 16px; height: 100%" valign="top">
  ...
  <tr>
    <td class="ram5">
      <div class="eventotekaMenu_title" style="margin: 0 0 0 0;">
        <a class="black" href="/resident_news">Новости резидентов</a>
      </div>
      <?php CRenderer::RenderControl("typeList"); ?>
    </td>
  </tr>
  </table>
  <img src="/images/front/0.gif" width="220" height="10">
...
<table border="0" cellpadding="0" cellspacing="0" class="tableInline" style="margin: 0 0px 0 0; width:auto;">
