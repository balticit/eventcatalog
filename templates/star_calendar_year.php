...
<html>
<head>
    <title>Звездное расписание - EVENT КАТАЛОГ</title>
...
<tr><td style="padding-left: 30px; padding-right: 30px; padding-top: 16px; height: 100%" valign="top">
	<div style="padding-left:15px;"><?php CRenderer::RenderControl("content"); ?><br>
		<?php CRenderer::RenderControl("year_calendar"); ?></div>
</td></tr>
