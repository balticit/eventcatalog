...
<html>
<head>
    <title>О проекте - EVENT КАТАЛОГ</title>
...
<tr><td style="padding-left: 30px; padding-right: 30px; padding-top: 16px; height: 100%" valign="top"><?php CRenderer::RenderControl("content"); ?></td></tr>
