...
<tr><td style="padding-left: 30px; padding-right: 30px; padding-top: 10px; height: 100%" valign="top">
	...
	<tr>
		...
		<td valign="top">	<div class="recomendTitle eventoteka h3">Эвентотека / Эвент ТВ <a target="_blank" class="yaWitgetLink" id="eventotekaYaWitget" href="http://www.yandex.ru/?add=83172&from=promocode">Виджет Эвентотеки на Яндексе</a></div><?php CRenderer::RenderControl("content"); ?></td>
