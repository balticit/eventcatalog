...
<html>
<head>
    <title>Партнеры - EVENT КАТАЛОГ</title>
...
<tr><td style="padding-left: 30px; padding-right: 30px; padding-top: 16px; height: 100%" valign="top">
	<div><?php CRenderer::RenderControl("text"); ?></div>
	<div><table cellpadding="0" cellspacing="10" border="0"><?php CRenderer::RenderControl("newsList"); ?></table></div></td></tr>
