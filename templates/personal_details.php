	...
	<tr>
		...
		<td valign="top" >
			<div align="center" style="padding-left:24px;">
                ...
                <tr>
                    <td valign="center" align="left"><a class="regis_top" href="/registration/personal/type/vacancy" style="color: rgb(113, 113, 113);">Добавить вакансию</a></td>
            		<td align="left" valign="center"><a class="regis_top" href="/registration/personal/type/cv" style="color: rgb(113, 113, 113);">Добавить резюме</a></td>				
                </tr>										
                </table>
            </div>
                ...
                <div class="left_list">
                    <div style="margin-bottom: 15px;">
                        ...
                        <div class="left_list" style="vertical-align:top">
                            ...
                            <tr>
                                <td align="left" valign="top" style="color: #AAAAAA; font-size:10px;"><div style=" padding-left:7px">ДОЛЖНОСТЬ</div></td>
                                <td align="right" valign="top" style="color: #AAAAAA; font-size:10px;"><div style="margin-right:3px">ДАТА РАЗМЕЩЕНИЯ ОБЪЯВЛЕНИЯ</div></td>
                            </tr></table>
