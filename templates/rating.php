...
<html>
<head>
  <title>Рейтинг компаний - EVENT КАТАЛОГ</title>
    ...
    <td class="ram5">
      ...
      <div><a style="color:#99cc00; margin-left: 0;" class="leftml2 leftmgray" href="/rating/agency">Рейтинг агентств</a></div>
		...
		<td style="vertical-align:top; padding-left:10px;">
			<div class="h3">Рейтинг компаний</div>
			
			<div style="padding-top:5px; ">
			  <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td>
  				  <table border="0" cellpadding="0" cellspacing="0"><?php CRenderer::RenderControl("rateListCont"); ?></table>
  				</td>
  				<td>
  				  <table border="0" cellpadding="0" cellspacing="0"><?php CRenderer::RenderControl("rateListArea"); ?></table>
  				</td>
  				<td>
  				  <table border="0" cellpadding="0" cellspacing="0"><?php CRenderer::RenderControl("rateListArtist"); ?></table>
  				</td>
  				<td>
  				  <table border="0" cellpadding="0" cellspacing="0"><?php CRenderer::RenderControl("rateListAgency"); ?></table>
  				</td>
				</tr>
				</table>
