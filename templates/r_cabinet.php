...
<html>
<head>
    <title>Личный кабинет - EVENT КАТАЛОГ</title>
    <?php CRenderer::RenderControl("metadata"); ?>
    <link rel="stylesheet" type="text/css" href="/styles/r_cabinet.css?<?php echo time(); ?>">
    <script type="text/javascript" language="JavaScript" src="/js/pro_account.js"></script>
</head>
<body>
