...
function getNewsItem($item){
	...
	$strItem.="<a href='/resident_news/news".$item['tbl_obj_id']."/' style='color: black;font-size:16px;font-weight:bold'>".$item['title']."</a><br/>";
...
if($days > 7) { return "больше недели назад";}
if($days > 3) { return declension($days,' день',' дн€',' дней')." назад";} 
if($days > 1 && $days <= 3) { return "позавчера";}
if($days = 1 ) { return "вчера";}
if($days < 1 && $hour < 23) { return "сегодн€";}
