<?php
	class opened_area_php extends CPageCodeHandler 
	{
		public $max_per_page = 5;
		...
		public function PreRender()
		{
			...
			$news = SQLProvider::ExecuteQuery( "select * from `vw__opened_areas` v order by v.date desc limit $this->max_per_page");
