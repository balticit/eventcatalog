<?php
	class show_technologies_details_php extends CPageCodeHandler 
	{
		public function show_technologies_details_php()
		{
		...
		public function PreRender()
		{
			...
			$unit = SQLProvider::ExecuteQuery("SELECT * from tbl__show_technologies where tbl_obj_id = $id");
			if (sizeof($unit)==0)
			{
			...
			$photos = SQLProvider::ExecuteQuery("SELECT
						  p.*
						FROM 
						  `tbl__show_technologies2photo`  ap
