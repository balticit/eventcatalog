...
class eventtv_details_php extends CPageCodeHandler
{
	...
	public function PreRender()
	{
		...
		if ($show_ilike) {
			...
			$btn_i_like='<img class="btn_ilike" src="/images/rating/hand_white.png">&nbsp;&nbsp;</td><td><form method="post" style="margin: 0; padding:0;"><input type="hidden" name="action" value="unlike"><a href="" class="black" onclick="javascript: $(this).parent().submit(); return false;">Больше не нравится</a></form>';
		}
