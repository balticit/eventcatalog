...
class agency_details_php extends CPageCodeHandler
{
    ...
    if (sizeof($unit)==1)
        ...
        if ($show_ilike) {
            ...
            $unit["btn_i_like"]='<img class="btn_ilike" src="/images/rating/hand_agency.png">&nbsp;&nbsp;</td><td><form method="post"><input type="hidden" name="action" value="unlike"><a href="" class="black" onclick="javascript: $(this).parent().submit(); return false;">Больше не нравится</a></form>';
        }
