...
class artist_php extends CPageCodeHandler
{
    ...
    SQLProvider::ExecuteNonReturnQuery("update $tbl set last_visit_date=NOW() WHERE tbl_obj_id = $user->id AND last_visit_date<DATE_SUB(NOW(), INTERVAL 1 MINUTE) ");
        ...
        $metadata->keywords = "ведущие на корпоратив, диджеи на свадьбу(dj), музыкальные группы на корпоратив, танцевальные шоу, шоу-программы на свадьбы и на праздники";
        $metadata->description = "EventCatalog.ru – удобный поиск артистов для мероприятия, праздника или свадьбы: ведущие, диджеи (dj), музыкальные группы, танцевальные шоу, шоу-программы… и многое другое!";
        ...
        */
				...
				$artistsearch->footerTemplate =
				 '<td class="artist"><div style="text-align:justify !important;"><p><span class="artist">Поиск по названию <input name="artist_doc_name" type="text" size="20" value="'.$artist_doc_name.'"></span>&nbsp;/&nbsp;<span class="artist">Поиск по стране '.$selcountry->Render().'</span>&nbsp;/&nbsp;<span id="find_style" class="artist" style="cursor: pointer;" onclick="FindStylesDlg()">Поиск по стилю</span> </p></div></td>
					</tr></table></form>';
