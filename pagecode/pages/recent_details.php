<?php
	class recent_details_php extends CPageCodeHandler 
	{
		public function recent_details_php()
		{
		...
		public function PreRender()
		{
			...
			$unit = SQLProvider::ExecuteQuery("SELECT * from tbl__recent where tbl_obj_id = $id");
			if (sizeof($unit)==0)
			{
