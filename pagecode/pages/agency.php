...
class agency_php extends CPageCodeHandler
{
    ...
    SQLProvider::ExecuteNonReturnQuery("update $tbl set last_visit_date=NOW() WHERE tbl_obj_id = $user->id AND last_visit_date<DATE_SUB(NOW(), INTERVAL 1 MINUTE) ");
        ...
        $metadata->keywords = "eventагентства, ивент агентства, агентства деловых мероприятий, концертные агентства, букинговые агентства, выставочные агентства, свадебные агентства, событийный туризм, инсентив";
        $metadata->description = "EventCatalog.ru – каталог eventагентств, организаторов мероприятий, концертных и букинговых агентств… и многое другое!";
