            ...
            if (strlen($filter) > 0) {
                ...
                foreach ($contractors as &$contractor)
                {
                  ...
                  foreach ($thumbs as $thumb) {
                    $contractor["thumbs"] .= '<li><img src="/thumb.php?src=/application/public/upload/'.$thumb["l_image"].'&amp;h=200&amp;w=200&amp;zc=1" alt="" /></li>';
                  }
                ...
                if((!isset($page)||$page==1)&&$activity==1141){                    
                    ...
                    $mf["thumbs"] = '';
                    foreach ($thumbs as $thumb) {
                      $mf["thumbs"] .= '<li><img src="/thumb.php?src=/upload/'.$thumb["l_image"].'&amp;h=200&amp;w=200&amp;zc=1" alt="" /></li>';
                    }
                    /* END ФОТКИ ГАЛЕРЕИ В СПИСКЕ */
