...
class KCAPTCHA{
	...
	function KCAPTCHA(){
		...
		$credits=$this->keystring;
		imagestring($img2, 2, $width/2-imagefontwidth(2)*strlen($credits)/2, $height-2, $credits, $background);

		// periods
		$rand1=mt_rand(750000,1200000)/10000000;
		$rand2=mt_rand(75000,120000)/10000000;
		$rand3=mt_rand(75000,120000)/10000000;
		$rand4=mt_rand(75000,120000)/10000000;
		// phases
		...
		// amplitudes
		$rand9=mt_rand(400,420)/110;
		$rand10=mt_rand(400,450)/110;
		...
		for($x=0;$x<$width;$x++){
			for($y=0;$y<$height;$y++){
				...
				imagesetpixel($img2,rand(0,$width),rand(0,$height),$color);
			}
		}
