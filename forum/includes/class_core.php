...
define('FILE_VERSION', '3.8.2'); // this should match install.php
define('SIMPLE_VERSION', '382'); // see vB_Datastore::check_options()
...
*
* @package	vBulletin
* @version	$Revision: 30112 $
* @date		$Date: 2009-03-30 08:38:13 -0500 (Mon, 30 Mar 2009) $
*/
class vB_Database
{
	/**
