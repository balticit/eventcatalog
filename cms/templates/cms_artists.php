...
<body>
<div style="padding-bottom:7px;"><form action="/cms/artists" method="get">		
	<center>
						...
						<table cellpadding="0" cellspacing="0" width="100%">
							<tr>
								...
								<td background="/images/search/bgind.gif" width="100%" style="vertical-align: top; padding-top: 5px;">
									...
									<input  value="" onchange="this.value=value + '%';" type="text" name="99_6$dataTable[$autoValues][title]" style="width: 100%; border: 0px black solid; color: gray;">
								</td>
