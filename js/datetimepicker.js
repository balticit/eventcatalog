...
var MonthNameRus = {"January":"Январь", "February":"Февраль", "March":"Март", "April":"Апрель", "May":"Май","June":"Июнь","July":"Июль","August":"Август", "September":"Сентябрь", "October":"Октябрь", "November":"Ноябрь", "December":"Декабрь"};
	...
	if (Cal.Scroller=="DROPDOWN")
	{
		...
		for (i=0;i<12;i++)
		{
			if (i==Cal.Month)
				...
				SelectStr="";	
				var a = MonthName[i];
			vCalHeader+="<option "+SelectStr+" value="+i+">"+MonthNameRus[a]+"</option>\n";
		}
